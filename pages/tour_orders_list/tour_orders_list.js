// pages/tour_orders_list/tour_orders_list.js
var app = getApp();
...
Page({
   ...
   */
  data: {
    order_container: ['all_orders_fix', 'all_orders', 'all_orders', 'all_orders'],
    order_list: [],
    page_num: 1,
    page_size: 6,
    //分页加载的开关
  ...
  onShow: function () {
    if (app.globalData.global_order_list_flash == "yes") {
      ...
      this.data.order_container = ['all_orders_fix', 'all_orders', 'all_orders', 'all_orders'];
  ...
  goto_order_detailHandle: function (e) {
    ...
    if (num != undefined && index != undefined) {
      ...
      wx.navigateTo({
        url: '../tour_orders_detail/tour_orders_detail'
      })
    }
  ...
  goto_iscompleted_order_detailHandle:function (e) {
    var num = e.target.dataset.num;
    if (num != undefined) {
      app.globalData.global_order_id = this.data.iscompleted_list[num].id;
      console.log(app.globalData.global_order_id);
      wx.navigateTo({
        url: '../tour_orders_detail/tour_orders_detail'
      })
  ...
  goto_comment_iscompleted_order_detailHandle(e){
    var num = e.target.dataset.num;

    if (num != undefined ) {
      app.globalData.global_productId_id = this.data.iscompleted_list[num].products[0].id;
      app.globalData.global_sellerId = this.data.iscompleted_list[num].sellerId;
      app.globalData.global_productId = this.data.iscompleted_list[num].products[0].productId;
      app.globalData.global_goods_detail = this.data.iscompleted_list[num].products[0];
      console.log(app.globalData.global_productId);
      wx.navigateTo({
        url: '../write_goods_comments/wirte_goods_comments'
      })
