    ...
    wx.request({
      ...
      success: function (res) {
        if (res.statusCode == 200) {
          ...
          var str_tmp = back.Address;
          str_tmp = str_tmp.split("|");
          self.data.guide_num = str_tmp[0];
          self.data.guide_language = str_tmp[1];
          ...
          self.setData({
            ...
            guide_language:self.data.guide_language,
            guide_num:self.data.guide_num
          });
          wx.hideLoading();
